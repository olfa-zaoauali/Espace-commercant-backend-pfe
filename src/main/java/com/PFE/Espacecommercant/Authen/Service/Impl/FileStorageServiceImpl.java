...
public class FileStorageServiceImpl implements FilesStorageService {
    private final Path root = Paths.get("C:\\Users\\HP\\Espace-commercant\\Espace-commercant\\src\\main\\webapp\\images");
    ...
    public Resource load(String filename) {
        try {
            ...
            if (resource.exists() || resource.isReadable()) {
                ...
                throw new RuntimeException("Could not read te file!");
            }
